...
async def do_receiver():
    ...
    # taking advantage of coroutines to restructure everything. Now we can deal
    # with each socket in isolation. I’ve created two coroutine functions, one
    # for each socket; this one is for the PULL socket.
