...
def handler(sig):
    ...
    # before the task created formain() was completed. Instead, we can initiate
    # task cancellation here, which will ultimately result in the main() task
    # exiting; when that happens, the cleanup handling inside asyncio.run()
    # will take over.
